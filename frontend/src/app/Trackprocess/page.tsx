...
export default function Hometrack() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-sky-500 to-indigo-500 flex flex-col justify-center items-center">
      <Head>
        <title>Welcome to HR Management Tracking Progress System</title>
      ...
      <div className="flex flex-col gap-4 w-full max-w-md">
        <Link href="/Trackprocess/trackbyorg/newtrackorg">
          <button className="text-white bg-indigo-600 hover:bg-indigo-700 font-bold rounded-lg px-4 py-2 shadow-md">
           Track create by Organization
          </button>
        </Link>
        <br></br>
        <br></br>
        <Link href="/Trackprocess/trackbyorg/updatetrackorg">
          <button className="text-white bg-indigo-600 hover:bg-indigo-700 font-bold rounded-lg px-4 py-2 shadow-md">
          Update track by Organization
          </button>
        </Link>
        <br></br>
        <br></br>
        <Link href="/Trackprocess/trackbymanager/newtrackmanager">
          <button className="text-white bg-indigo-600 hover:bg-indigo-700 font-bold rounded-lg px-4 py-2 shadow-md">
          Track create by Manager
          </button>
        </Link>
        <br></br>
        <br></br>
        <Link href="/Trackprocess/trackbymanager/updatetrackmanager">
          <button className="text-white bg-gray-800 hover:bg-gray-700 font-bold rounded-lg px-4 py-2 shadow-md">
          Update track by Manager
          </button>
        </Link>
        <br></br>
        <br></br>
        <Link href="/Trackprocess/trackbyorg/viewtrackorg">
          <button className="text-white bg-gray-800 hover:bg-gray-700 font-bold rounded-lg px-4 py-2 shadow-md">
          View track by Organization
          </button>
        </Link>
        <br></br>
