...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-sky-500 to-indigo-500 flex flex-col justify-center items-center">
      <Head>
        <title>Welcome to HR Management Subscription System</title>
      ...
      <div className="flex flex-col gap-4 w-full max-w-md">
        ...
        <Link href="/Subscription/subadmin/">
        ...
        <Link href="/Subscription/viewallSupadmin/">
          <button className="text-white bg-gray-800 hover:bg-gray-700 font-bold rounded-lg px-4 py-2 shadow-md mb-4">
            View Subscription of SuperAdmins
          </button>
        </Link>
        <br></br>
        <br></br>

        <Link href="/Subscription/suborg/">
          <button className="text-white bg-gray-800 hover:bg-gray-700 font-bold rounded-lg px-4 py-2 shadow-md mb-4">
            Subscription for Organization!
          </button>
        </Link>
        <br></br>
        <br></br>

        <Link href="/Subscription/viewallorg/">
          <button className="text-white bg-gray-800 hover:bg-gray-700 font-bold rounded-lg px-4 py-2 shadow-md mb-4">
            View Subscription of Organizations!
          </button>
        </Link>
        <br></br>
