...
export default function HomeCredit() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-sky-500 to-indigo-500 flex flex-col justify-center items-center">
      <Head>
        <title>Welcome to HR Management  Credit System</title>
      ...
      <p className="text-xl text-gray-200 text-center mb-8">
        This is Credit Board
      </p>

      <div className="flex flex-col gap-4 w-full max-w-md">
        <Link href="/Creditsystem/Manager/addcreditprofile">
        ...
        <br></br>
        <br></br>
        <Link href="/Creditsystem/Manager/viewcreditbymanager">
          <button className="text-white bg-indigo-600 hover:bg-indigo-700 font-bold rounded-lg px-4 py-2 shadow-md">
          View Credit Profile by One
          </button>
        </Link>
        <br></br>
        <br></br>
        <Link href="/Creditsystem/Manager/viewall">
          <button className="text-white bg-indigo-600 hover:bg-indigo-700 font-bold rounded-lg px-4 py-2 shadow-md">
          View All Credit Profile
          </button>
        </Link>
        <br></br>
        <br></br>
        <Link href="/Creditsystem/Manager/updatecreditbymanager">
          <button className="text-white bg-indigo-600 hover:bg-indigo-700 font-bold rounded-lg px-4 py-2 shadow-md">
        ...
        <br></br>
        <br></br>
        <Link href="/Creditsystem/Manager/Deletecreditprofile">
          <button className="text-white bg-indigo-600 hover:bg-indigo-700 font-bold rounded-lg px-4 py-2 shadow-md">
